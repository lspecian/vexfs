...
impl Dentry {
    #[cfg(feature = "kernel")]
    pub fn d_make_root(_inode: alloc::sync::Arc<crate::fs_core::Inode>) -> Option<*mut c_void> {
        // Stub implementation
...
#[cfg(feature = "kernel")]
fn create_root_inode() -> Result<alloc::sync::Arc<crate::fs_core::Inode>> {
    use crate::fs_core::Inode;
...
pub fn vexfs_fill_super(
    ...
    #[cfg(feature = "kernel")]
    let vex_sb = alloc::boxed::Box::new(VexfsSuperblock::new());
    #[cfg(not(feature = "kernel"))]
    let vex_sb = std::boxed::Box::new(VexfsSuperblock::new());
    ...
    #[cfg(feature = "kernel")]
    {
        sb.s_fs_info = alloc::boxed::Box::into_raw(vex_sb) as *mut c_void;
    }
    #[cfg(not(feature = "kernel"))]
    {
        sb.s_fs_info = std::boxed::Box::into_raw(vex_sb) as *mut c_void;
    }
    ...
    let root_inode_arc = match create_root_inode() {
        ...
        Err(e) => {
            ...
            unsafe {
                #[cfg(feature = "kernel")]
                let _ = alloc::boxed::Box::from_raw(sb.s_fs_info as *mut VexfsSuperblock);
                #[cfg(not(feature = "kernel"))]
                let _ = std::boxed::Box::from_raw(sb.s_fs_info as *mut VexfsSuperblock);
            }
...
pub fn vexfs_kill_sb(sb: &mut SuperBlock) {
    ...
    if !sb.s_fs_info.is_null() {
        unsafe {
            ...
            #[cfg(feature = "kernel")]
            let _vex_sb_box = alloc::boxed::Box::from_raw(sb.s_fs_info as *mut VexfsSuperblock);
            #[cfg(not(feature = "kernel"))]
            let _vex_sb_box = std::boxed::Box::from_raw(sb.s_fs_info as *mut VexfsSuperblock);
