...
pub mod system_hang_prevention;
...
// Hang prevention system
pub use system_hang_prevention::{
    HangPreventionManager, OperationType, Priority, WatchdogId, WatchdogTimer,
    DegradationLevel, SystemHealthStatus, PanicRecoveryStrategy, PanicContext,
    init_hang_prevention, shutdown_hang_prevention, get_system_health,
...
pub use memory_management::{
    MemoryPool, MemoryStats, AtomicRefPtr, SafeMemoryAccess, MemoryBarriers,
    get_memory_stats, track_allocation, track_deallocation, detect_memory_leaks,
    reset_memory_stats, tracked_alloc, tracked_dealloc, validate_user_memory,
    safe_string_copy,
};
