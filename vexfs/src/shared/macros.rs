...
macro_rules! vexfs_error {
    ($fmt:expr) => {
        kernel_or_std!(
            kernel: printk!(KERN_ERR "vexfs: " $fmt),
            std: eprintln!("vexfs error: {}", $fmt)
        )
    };
    ($fmt:expr, $($arg:tt)*) => {
        kernel_or_std!(
            kernel: printk!(KERN_ERR "vexfs: " $fmt, $($arg)*),
...
macro_rules! vexfs_warn {
    ($fmt:expr) => {
        kernel_or_std!(
            kernel: printk!(KERN_WARNING "vexfs: " $fmt),
            std: eprintln!("vexfs warning: {}", $fmt)
        )
    };
    ($fmt:expr, $($arg:tt)*) => {
        kernel_or_std!(
            kernel: printk!(KERN_WARNING "vexfs: " $fmt, $($arg)*),
...
macro_rules! vexfs_info {
    ($fmt:expr) => {
        kernel_or_std!(
            kernel: printk!(KERN_INFO "vexfs: " $fmt),
            std: println!("vexfs info: {}", $fmt)
        )
    };
    ($fmt:expr, $($arg:tt)*) => {
        kernel_or_std!(
            kernel: printk!(KERN_INFO "vexfs: " $fmt, $($arg)*),
...
macro_rules! vexfs_debug {
    ($fmt:expr) => {
        ...
        kernel_or_std!(
            kernel: printk!(KERN_DEBUG "vexfs: " $fmt),
    ...
    ($fmt:expr, $($arg:tt)*) => {
        #[cfg(debug_assertions)]
        kernel_or_std!(
            kernel: printk!(KERN_DEBUG "vexfs: " $fmt, $($arg)*),
